...
/// <summary>
/// A recurring day-of-week working window for a partner (PARTNER.md
/// "partner_availability: Day-of-week windows, blackout dates - feeds the
...
/// separate rule child - a partner's own weekly schedule does not need
...
/// <c>SlotWindow</c>s to compute a partner's actual bookable slots - not
/// built in this pass.
/// </summary>
public class PartnerAvailabilityWindow : Entity<Guid>
{
    ...
    protected PartnerAvailabilityWindow() { }

    public PartnerAvailabilityWindow(Guid id, Guid partnerId, DayOfWeek dayOfWeek, TimeSpan startTime, TimeSpan endTime)
        : base(id)
    {
        PartnerId = partnerId;
        DayOfWeek = dayOfWeek;
