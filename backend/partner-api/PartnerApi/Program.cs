...
// Partner JWT bearer auth (task 146b, PARTNER.md API surface) — its own
...
// OTP/login endpoints are unauthenticated — there is no partner identity yet
// to key on. The per-mobile-number lockout inside PartnerLoginService is what
