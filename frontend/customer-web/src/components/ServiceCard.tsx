...
export function ServiceCard({
  ...
  return (
    <Link
      href={`/services/${slug}`}
      className="group flex flex-col rounded-2xl border border-line bg-surface p-5 shadow-xs transition duration-200 ease-out hover:-translate-y-0.5 hover:border-brand-600/30 hover:shadow-md"
    >
