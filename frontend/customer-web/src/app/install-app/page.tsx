...
/**
 * Post-signup / mobile sign-in "install as an app" screen. Nestly's mobile
 * traffic is primarily the browser, not a native app, so this is the moment
 * a customer is most receptive to putting it on their home screen. Desktop
 * visitors and anyone already running the installed PWA skip straight past
 * it - there's nothing useful to show them here.
 */
...
function InstallScreen() {
  ...
  const next = resolvePostLoginPath(useSearchParams().get("next"));
