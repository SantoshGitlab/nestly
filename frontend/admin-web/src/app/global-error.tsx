 ...
 * leaving the operator with a blank document. The inline <style> is the only
 * way to stay theme-aware without that dependency, and is the one place in the
 * app where literal hex values are correct: no stylesheet is guaranteed loaded
 * here, so the token variables may not exist.
 */
      ...
      <body>
        ...
        <div className="ne-wrap">
          <div className="ne-card">
            ...
            <p className="ne-body">
              The admin panel failed to start. Reloading usually fixes it — no changes were saved.
            </p>
