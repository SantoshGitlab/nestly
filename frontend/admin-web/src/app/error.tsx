 ...
 * client-side exception has occurred" with no way back into the panel.
 *
...
export default function AdminError({
  ...
  useEffect(() => {
    ...
    // an operator's own devtools; wiring this to a real reporter is a later task.
    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-2 text-sm leading-relaxed text-fg-muted text-pretty">
          This screen failed to load. Trying again usually fixes it — no changes were saved.
        </p>
