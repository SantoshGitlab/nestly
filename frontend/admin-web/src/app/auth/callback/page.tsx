 ...
 * (customer-web's `/login`, task 206) after a successful admin sign-in
 ...
 * does after calling admin-api directly.
 */
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    ...
    const session: AdminLoginResponse = { accessToken, refreshToken, accessTokenExpiresAtUtc };
