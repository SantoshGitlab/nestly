...
export function THead({ children }: { children: ReactNode }) {
  // No header shading (matches the MatDash reference: the header sits on
  // the same white card surface as the body, distinguished by weight/color
  // alone, not a tinted band).
  return (
...
export function TH({
  ...
  return (
    <th
      scope="col"
      className={cx(
        // 14px/700, normal case, near-fg color - matches the MatDash
        // reference's header cells exactly (their computed style has no
        // uppercase/tracking and is barely lighter than body text).
