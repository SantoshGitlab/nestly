...
/**
 * Ad hoc dates a provider is not available on, overriding the weekly windows
 * above (docs/PROVIDER.md's `provider_availability` blackout dates).
 *
 ...
 * this screen would mean a provider tapping "Today" blocking the wrong day.
 *
 ...
 * provider is checking), then the finished ones newest-first below. Display
