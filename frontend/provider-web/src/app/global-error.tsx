 ...
 * leaving the provider with a blank document. The inline <style> is the only
 * way to stay theme-aware without that dependency.
 */
export default function ProviderGlobalError({
  error,
  reset,
}: {
      ...
      <body>
        ...
        <div className="ne-wrap">
          <div className="ne-card">
            ...
            <p className="ne-body">
              The app failed to start. Reloading usually fixes it — your account and jobs are
              unaffected.
            </p>
