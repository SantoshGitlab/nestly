# CLAUDE.md — frontend/partner-web
...
implementation, plus `docs/PARTNER.md` for module context and
...
A Next.js 14 partner-facing portal (task 151, docs/PARTNER.md) for
`backend/partner-api`: OTP-based registration/login, profile & KYC
