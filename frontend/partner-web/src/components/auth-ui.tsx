...
/**
 * Shared furniture for the partner authentication screens (login, register).
 *
 ...
 * recognisably one product; the differences here are the partner wordmark and
 * the full-viewport height (partner-web's auth routes sit outside the
 * `(partner)` group and so render with no app header above them).
 */
    ...
    <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2" aria-label="Nestly Partner home">
            <span
              aria-hidden
 ...
 * path for the overwhelming majority of real users — and for a partner
 * signing in one-handed on site it is the only path worth optimising for.
 ...
 * partners hammer it — every press costs an SMS and, on most gateways, trips
