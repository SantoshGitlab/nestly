...
/**
 * The screen-level states every data-backed partner screen needs.
 *
 ...
 * `NotYetAvailable` also encodes this app's HTTP 501 contract with partner-api,
 ...
 *
 * Every partner screen is a heading over stacked `Card`s, so this is the shape
