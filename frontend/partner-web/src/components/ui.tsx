...
/**
 * The shared primitives every partner-web screen is built from. Mirrors
 * admin-web/src/components/ui.tsx (itself mirroring customer-web's) exactly
 * so all of Nestly's frontends feel like siblings built the same way - a
 * design system of its own is out of scope here, but duplicating Tailwind
 * class strings across a dozen partner forms is not maintainable either.
 */
