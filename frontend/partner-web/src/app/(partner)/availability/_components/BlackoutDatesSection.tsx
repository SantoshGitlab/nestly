...
/** Ad hoc dates a partner is not available on (docs/PARTNER.md's `partner_availability` blackout dates). */
export function BlackoutDatesSection() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["partner-blackout-dates"] }),
  });
