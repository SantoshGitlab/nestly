...
/**
 * Job list (docs/PARTNER.md's `booking_partner_assignment` bridge table):
 ...
 *
 * Rows are cards, not a table: partners read this on a phone in the field,
...
export default function JobsPage() {
  ...
  const query = useQuery({
    queryKey: ["partner-jobs", appliedStatus, appliedDate],
          ...
          <EmptyState
            ...
            action={
              hasFilters ? (
                ...
                // that actually gets a partner matched to work.
