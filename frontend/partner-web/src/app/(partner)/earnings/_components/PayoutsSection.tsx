...
/**
 * Payout batches (docs/PARTNER.md's `partner_payout` table — a manual bank
 * transfer in v1, so a partner reads this to answer "has it been sent yet").
 *
...
export function PayoutsSection() {
  const query = useQuery({ queryKey: ["partner-payouts"], queryFn: listPayouts });
