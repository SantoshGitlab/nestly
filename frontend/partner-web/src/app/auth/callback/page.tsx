...
import type { PartnerLoginResponse } from "@/lib/types";

const DEFAULT_DESTINATION = "/jobs";

/**
 * Receives a session handed off from the unified login entry point
 * (customer-web's `/login`, task 206) after a successful partner sign-in
 ...
 * does after calling partner-api directly.
 */
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    ...
    const session: PartnerLoginResponse = { accessToken, refreshToken, accessTokenExpiresAtUtc };
