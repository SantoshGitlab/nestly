...
import { registerPartner, requestRegistrationOtp } from "@/lib/auth-api";
...
/**
 * Partner registration (docs/PARTNER.md's OTP-based auth): mobile number
 * entry requests an OTP, then the partner supplies their details alongside
 ...
 * partner to /login to sign in with a fresh OTP).
 */
export default function PartnerRegisterPage() {
  ...
  const detailsForm = useForm<DetailsFormValues>({
    ...
    defaultValues: {
      ...
      // partner never gave, and would make the schema's z.literal(true) rule
      // unreachable.
  ...
  // Same endpoint as the first send; the countdown is what prevents a partner
          ...
          <form onSubmit={submitRegistration} className="flex flex-col gap-5" noValidate>
            ...
            <div className="flex flex-col gap-4 border-t border-line pt-5">
              ...
              <div className="flex flex-col gap-1.5">
                <CheckboxField
                  label="I accept the partner terms and conditions"
