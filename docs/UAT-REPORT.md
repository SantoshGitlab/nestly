...
| Admin can manage bookings end-to-end | PASS | `BookingsController` (admin-api) confirmed live: list, detail, status, cancel, reschedule, refund, assign-partner, reject-assignment, assignments - all routed and authorized |
